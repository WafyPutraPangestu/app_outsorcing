    ...
    <div class="max-w-2xl mx-auto">
        <div class="valdo-card valdo-card-glow-blue">
            <div class="valdo-card-header border-b border-white/5 pb-4 mb-6">
                <div>
                    <h2 class="valdo-heading-lg">Tambah Kriteria Baru</h2>
                    <p class="valdo-text-muted mt-1">Buat parameter baru untuk form penilaian klien.</p>
                </div>
            </div>
            ...
            <form wire:submit.prevent="save">
                <div class="valdo-input-group mb-4">
                    ...
                    <input type="text" wire:model="nama_kriteria"
                        ...
                        placeholder="Contoh: Kedisiplinan & Kehadiran">
                    @error('nama_kriteria')
                ...
                <div class="valdo-input-group mb-6">
                    ...
                    @error('bobot_nilai')
                        <span class="valdo-input-error">{{ $message }}</span>
                    @enderror
                    <span class="valdo-input-hint">Porsi nilai ini terhadap total evaluasi.</span>
                </div>
                ...
                <div
                    ...
                    <div>
                        ...
                        <span class="text-xs text-gray-500">Aktifkan agar kriteria ini langsung muncul di form
                            Klien.</span>
                    </div>
                ...
                <div class="pt-6 border-t border-white/5 flex justify-end gap-3">
                    ...
                    <button type="submit" class="valdo-btn valdo-btn-primary" wire:loading.class="loading">
                        <span wire:loading.remove>Simpan Kriteria</span>
