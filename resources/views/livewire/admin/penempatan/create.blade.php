    ...
    <div class="max-w-3xl mx-auto">
        <div class="valdo-card valdo-card-glow-blue">
            <div class="valdo-card-header border-b border-white/5 pb-4 mb-6">
                <div>
                    <h2 class="valdo-heading-lg">Tambah Penempatan Kerja</h2>
                    <p class="valdo-text-muted mt-1">Tugaskan karyawan aktif ke perusahaan klien.</p>
                </div>
            </div>
            ...
            <form wire:submit.prevent="save">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="valdo-input-group">
                        ...
                        @error('tanggal_selesai')
                            <span class="valdo-input-error">{{ $message }}</span>
                        @enderror
                        <span class="valdo-input-hint">Kosongkan jika kontrak berjalan tanpa batas waktu
                            tertentu.</span>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div>
                        ...
                        <span class="text-xs text-gray-500">Karyawan dengan penempatan aktif akan dimunculkan saat
                            membuat Magic Link Evaluasi.</span>
                    </div>
                ...
                <div class="pt-6 border-t border-white/5 flex justify-end gap-3">
                    ...
                    <button type="submit" class="valdo-btn valdo-btn-primary" wire:loading.class="loading">
                        <span wire:loading.remove>Simpan Penempatan</span>
