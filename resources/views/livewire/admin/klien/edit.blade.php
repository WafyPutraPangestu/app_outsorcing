    ...
    <div class="max-w-2xl mx-auto">
        <div class="valdo-card valdo-card-glow-purple">
            <div class="valdo-card-header">
                <div>
                    <h2 class="valdo-heading-lg">Edit Data Klien</h2>
                    <p class="valdo-text-muted mt-1">Perbarui informasi untuk <span
                            class="text-accent-cyan font-bold">{{ $klien->nama_perusahaan }}</span></p>
                </div>
            </div>
            ...
            <form wire:submit.prevent="update">
                ...
                <div class="valdo-input-group mb-8">
                    ...
                    <textarea wire:model="alamat_kantor" class="valdo-textarea @error('alamat_kantor') error @enderror"></textarea>
                    @error('alamat_kantor')
                        <span class="valdo-input-error">{{ $message }}</span>
                    @enderror
                </div>
